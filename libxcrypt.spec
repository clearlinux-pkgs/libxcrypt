...
Version  : 4.4.38
Release  : 6
URL      : https://github.com/besser82/libxcrypt/archive/v4.4.38/libxcrypt-4.4.38.tar.gz
Source0  : https://github.com/besser82/libxcrypt/archive/v4.4.38/libxcrypt-4.4.38.tar.gz
...
%prep
%setup -q -n libxcrypt-4.4.38
cd %{_builddir}/libxcrypt-4.4.38
pushd ..
cp -a libxcrypt-4.4.38 build32
popd
pushd ..
cp -a libxcrypt-4.4.38 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736965590
