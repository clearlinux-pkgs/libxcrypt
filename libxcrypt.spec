...
Version  : 4.4.37
Release  : 5
URL      : https://github.com/besser82/libxcrypt/archive/v4.4.37/libxcrypt-4.4.37.tar.gz
Source0  : https://github.com/besser82/libxcrypt/archive/v4.4.37/libxcrypt-4.4.37.tar.gz
...
%prep
%setup -q -n libxcrypt-4.4.37
cd %{_builddir}/libxcrypt-4.4.37
pushd ..
cp -a libxcrypt-4.4.37 build32
popd
pushd ..
cp -a libxcrypt-4.4.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735576524
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcrypt.so.1.1.0
